...
sed -n -e 4,7p -e 19,22p hall-2.txt >> screens.txt
...
# Semi-full base image
sed -n 4,22p wall-1.txt >> screens.txt
...
sed -n 1,4p wall-1-5.txt >> screens.txt
sed -n 1,4p wall-1-6.txt >> screens.txt
sed -n -e 4,7p -e 19,22p wall-2-3.txt >> screens.txt
sed -n -e 4,7p -e 19,22p wall-2-4.txt >> screens.txt
sed -n -e 4,7p -e 19,22p wall-2-5.txt >> screens.txt
sed -n -e 4,7p -e 19,22p wall-2-6.txt >> screens.txt
